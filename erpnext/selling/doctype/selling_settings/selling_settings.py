...
class SellingSettings(Document):
    ...
    if TYPE_CHECKING:
        ...
        cust_master_name: DF.Literal["Customer Name",
        ...
        sales_update_frequency: DF.Literal["Monthly",
    ...
    def toggle_discount_accounting_fields(self):
        ...
        if enable_discount_accounting:
            ...
            default_discount_account = frappe.get_cached_value(
                "Company", default_company, "default_discount_account"
            )

            if not default_discount_account:
                frappe.throw(
                    _("The default discount account is not set in the company. Please set it in the company setting."),
                    title=_("Default Discount Account Missing"),
                )
